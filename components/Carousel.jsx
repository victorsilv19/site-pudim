...
export function Carousel({ products }) {
  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto px-0">
      {/* Carousel Container */}
      <div className="relative overflow-hidden rounded-lg sm:rounded-2xl bg-gray-100 aspect-square sm:aspect-video">
        ...
        <button
          onClick={prev}
          className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 z-10 bg-white/80 hover:bg-white rounded-full p-2 sm:p-3 transition-all duration-200 shadow-lg hover:shadow-xl"
        ...
        <button
          onClick={next}
          className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 z-10 bg-white/80 hover:bg-white rounded-full p-2 sm:p-3 transition-all duration-200 shadow-lg hover:shadow-xl"
